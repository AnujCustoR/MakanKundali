...
public class SplashActivity extends AwesomeSplash {
    ...
    public void initSplash(ConfigSplash configSplash) {
        ...
        configSplash.setBackgroundColor(R.color.PaleTurquoise); //any color you want form colors.xml
        ...
        //Customize Logo
        configSplash.setLogoSplash(R.mipmap.logo1); //or any other drawable
        ...
        //Customize Title
        configSplash.setTitleSplash("Makan Kundali");
        configSplash.setTitleTextColor(R.color.DarkCyan);
