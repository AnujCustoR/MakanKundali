package online.anujprolabs.makankundali;
...
public class OwnActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.materialViewPager.getViewPager().setAdapter(new FragmentStatePagerAdapter(getSupportFragmentManager()) {
            ...
            public CharSequence getPageTitle(int position) {
                switch (position) {
                    case 0:
                        return getResources().getString(R.string.my_house);
                    case 1:
                        return getResources().getString(R.string.owner);
                    case 2:
                        return getResources().getString(R.string.tenant);
                    case 3:
                        return getResources().getString(R.string.houses);
                    default:
                ...
                if (oldItemPosition != position) {
                    ...
                    switch (position) {
                        case 0:
                            ...
                            newDrawable = getResources().getDrawable(R.mipmap.tp2);
                            break;
                        case 1:
                            imageUrl = "http://www.larousse.fr/encyclopedie/data/images/1311904-Balle_de_tennis_et_filet.jpg";
                            color = getResources().getColor(R.color.orange);
                            newDrawable = getResources().getDrawable(R.mipmap.owner3);
                            break;
                        case 2:
