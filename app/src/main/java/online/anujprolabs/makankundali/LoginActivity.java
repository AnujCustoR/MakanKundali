    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(this, permissionsRequired[0]) != PackageManager.PERMISSION_GRANTED
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, permissionsRequired[0])
                ...
                ActivityCompat.requestPermissions(this, permissionsRequired, MY_PERMISSIONS_REQUEST_READ_CONTACTS);
            }
        }
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_READ_CONTACTS: {
                if (grantResults.length > 0  && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(this, "Please grant all necessary permissions from settings!", Toast.LENGTH_LONG).show();
                }
                return;
            }
        }
