...
public class PhoneAuthActivity extends AppCompatActivity implements
    ...
    Button mStartButton, mVerifyButton, mResendButton, mChangeNumber;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tPhoneNumber = (TextView) findViewById(R.id.text_phone_number);

        mStartButton = (Button) findViewById(R.id.button_start_verification);
        mVerifyButton = (Button) findViewById(R.id.button_verify_phone);
        mResendButton = (Button) findViewById(R.id.button_resend);
        mChangeNumber = (Button) findViewById(R.id.button_change_phone);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button_start_verification:
                ...
                tPhoneNumber.setText("Phone Number: "+ mPhoneNumberField.getText().toString());
            ...
            case R.id.button_change_phone:
                ...
                //tPhoneNumber.setText(mPhoneNumberField.getText().toString());
                mVerifyButton.setVisibility(View.GONE);
                mVerificationField.setVisibility(View.GONE);
                mResendButton.setVisibility(View.GONE);
                tPhoneNumber.setVisibility(View.GONE);
